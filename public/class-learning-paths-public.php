...
class Learning_Paths_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Learning_Paths_Public_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Learning_Paths_Public_Loader will then create the relationship
